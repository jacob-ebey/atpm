/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 412fc1e2609aa2972be4fac3a4f9872d)
...
interface __BaseEnv_CloudflareBindings {
  ...
  ATPROTO_STORE: DurableObjectNamespace<import("./src/server").AtprotoStore>;
  CLI_AUTH_SESSION: DurableObjectNamespace<import("./src/server").CliAuthSession>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/server");
    durableNamespaces: "AtprotoStore" | "CliAuthSession";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      "PRIVATE_KEY_JWK" | "SESSION_SECRET" | "INDEXER_SECRET" | "INDEXER_BASE_URL"
    >
  > {}
}
